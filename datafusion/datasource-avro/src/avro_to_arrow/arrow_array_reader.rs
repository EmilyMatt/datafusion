    ...
    fn test_avro_combined_refs() {
        ...
        let t1 = Value::Record(vec![
            ...
            (
                ...
                Value::Array(vec![
                    Value::Fixed(32, sig1.clone()),
                    Value::Fixed(32, sig2.clone()),
                    Value::Fixed(32, sig3.clone()),
                ]),
            ),
        ]);
        ...
        let t2 = Value::Record(vec![
            ...
            (
                "signatures".to_string(),
                Value::Array(vec![Value::Fixed(32, sig2.clone())]),
            ),
        ]);
        ...
        assert!(matches!(schema.field(8).data_type(), DataType::List(_))); // signatures
